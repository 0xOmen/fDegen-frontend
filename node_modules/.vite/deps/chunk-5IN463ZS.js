  ...
  block: defineBlock({
    format(args) {
      const transactions = args.transactions?.map((transaction) => {
        if (typeof transaction === "string")
          return transaction;
        const formatted = formatters2.transaction?.format(transaction);
    ...
    if (options.format === "feePayer" && signature) {
      ...
      if (sig.type === "secp256k1")
        return recoverAddress({
          payload: getSignPayload(from7(envelope)),
...
//# sourceMappingURL=chunk-5IN463ZS.js.map
