...
var SHA1 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T3 = rotl(A2, 5) + F2 + E + K3 + SHA1_W[i3] | 0;
      E = D2;
      D2 = C3;
      C3 = rotl(B3, 30);
      B3 = A2;
...
function invert(number, modulo) {
  ...
  let b2 = modulo;
  let x2 = _0n3, y3 = _1n3, u4 = _1n3, v3 = _0n3;
  while (a3 !== _0n3) {
    const q2 = b2 / a3;
    const r4 = b2 % a3;
    const m2 = x2 - u4 * q2;
    const n2 = y3 - v3 * q2;
    b2 = a3, a3 = r4, x2 = u4, y3 = v3, u4 = m2, v3 = n2;
  }
  const gcd = b2;
  if (gcd !== _1n3)
...
function Field(ORDER, bitLenOrOpts, isLE5 = false, opts = {}) {
  if (ORDER <= _0n3)
...
function _splitEndoScalar(k3, basis, n2) {
  ...
  if (k2neg)
    k22 = -k22;
  const MAX_NUM = bitMask(Math.ceil(bitLen(n2) / 2)) + _1n5;
...
function mapToCurveSimpleSWU(Fp3, opts) {
  ...
  return (u4) => {
    ...
    const e1 = Fp3.isOdd(u4) === Fp3.isOdd(y3);
...
function ecdsa(Point2, hash, ecdsaOpts = {}) {
  ...
  class Signature {
    ...
    static fromBytes(bytes, format2 = defaultSigOpts_format) {
      ...
      let recid;
      if (format2 === "der") {
        const { r: r5, s: s4 } = DER.toSig(_abytes2(bytes));
    ...
    recoverPublicKey(messageHash) {
      ...
      const R = Point2.fromBytes(concatBytes(pprefix((rec & 1) === 0), x2));
    ...
    toBytes(format2 = defaultSigOpts_format) {
      ...
      if (format2 === "recovered") {
        ...
        return concatBytes(Uint8Array.of(this.recovery), r4, s3);
      }
      return concatBytes(r4, s3);
    }
    toHex(format2) {
...
function weierstrassPoints(c3) {
  ...
  return _weierstrass_new_output_to_legacy(c3, Point2);
}
...
function _weierstrass_new_output_to_legacy(c3, Point2) {
  const { Fp: Fp3, Fn } = Point2;
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    if (!inRange(r4, _1n6, secp256k1_CURVE.p))
      return false;
    const s3 = num(sig.subarray(32, 64));
    if (!inRange(s3, _1n6, secp256k1_CURVE.n))
      return false;
...
var _Field6 = class {
  ...
  sqr({ c0, c1, c2: c22 }) {
    ...
    let t3 = Fp22.mul(Fp22.mul(c1, c22), _2n6);
    let t4 = Fp22.sqr(c22);
    return {
...
function signatureG1FromBytes(hex) {
  ...
  if (y3 * _2n7 / P2 !== aflag)
    y3 = Fp.neg(y3);
  const point = Point2.fromAffine({ x: x2, y: y3 });
  point.assertValidity();
  return point;
}
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    if (is0)
      return concatBytes(COMPZERO, numberToBytesBE(_0n9, L2));
    const flag = Boolean(y3.c1 === _0n9 ? y3.c0 * _2n7 / P2 : y3.c1 * _2n7 / P2);
...
function pointG2FromBytes(bytes) {
  ...
  if (value.length === 96 && compressed) {
    ...
    const Y_bit = y3.c1 === _0n9 ? y3.c0 * _2n7 / P2 : y3.c1 * _2n7 / P2 ? _1n9 : _0n9;
...
function signatureG2FromBytes(hex) {
  ...
  const is0 = y1 === _0n9 && y0 * _2n7 / P2 !== aflag1;
  if (isGreater || is0)
    y3 = Fp2.neg(y3);
  const point = Point2.fromAffine({ x: x3, y: y3 });
  point.assertValidity();
  return point;
}
var bls12_381 = bls({
...
// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/crypto.js
var crypto4 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/utils.js
...
// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/_md.js
...
// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/legacy.js
...
var SHA12 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T3 = rotl2(A2, 5) + F2 + E + K3 + SHA1_W2[i3] | 0;
      E = D2;
      D2 = C3;
      C3 = rotl2(B3, 30);
      B3 = A2;
...
var sha12 = createHasher4(() => new SHA12());
...
var md52 = createHasher4(() => new MD52());
...
var ripemd1603 = createHasher4(() => new RIPEMD1602());

// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@base-org/account/node_modules/@scure/bip32/node_modules/@noble/hashes/esm/sha2.js
...
var SHA2563 = class extends HashMD3 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 64; i3++) {
      ...
      const T22 = sigma0 + Maj3(A2, B3, C3) | 0;
      H = G;
      G = F2;
      F2 = E;
      E = D2 + T1 | 0;
...
// node_modules/@base-org/account/node_modules/@scure/bip32/lib/esm/index.js
var Point = secp256k1.ProjectivePoint;
var base58check = createBase58check(sha2565);
var MASTER_SECRET = utf8ToBytes3("Bitcoin seed");

// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/crypto.js
var crypto5 = typeof globalThis === "object" && "crypto" in globalThis ? globalThis.crypto : void 0;

// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/utils.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/hmac.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_md.js
...
function Chi4(a3, b2, c3) {
  return a3 & b2 ^ ~a3 & c3;
}
function Maj4(a3, b2, c3) {
  return a3 & b2 ^ a3 & c3 ^ b2 & c3;
}
...
var SHA224_IV4 = Uint32Array.from([
  3238371032,
  914150663,
  812702999,
  4144912697,
...
var SHA384_IV4 = Uint32Array.from([
  3418070365,
  3238371032,
  1654270250,
  914150663,
...
var SHA512_IV4 = Uint32Array.from([
  1779033703,
  4089235720,
  3144134277,
  2227873595,
...
// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/_u64.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/node_modules/@noble/hashes/esm/sha2.js
...
var SHA2564 = class extends HashMD4 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 64; i3++) {
      ...
      const T22 = sigma0 + Maj4(A2, B3, C3) | 0;
      H = G;
      G = F2;
      F2 = E;
      E = D2 + T1 | 0;
...
var SHA2244 = class extends SHA2564 {
  constructor() {
    super(28);
    this.A = SHA224_IV4[0] | 0;
    this.B = SHA224_IV4[1] | 0;
    this.C = SHA224_IV4[2] | 0;
    this.D = SHA224_IV4[3] | 0;
    this.E = SHA224_IV4[4] | 0;
    this.F = SHA224_IV4[5] | 0;
    this.G = SHA224_IV4[6] | 0;
    this.H = SHA224_IV4[7] | 0;
  }
};
var K5124 = (() => split4([
  "0x428a2f98d728ae22",
...
var SHA512_Kh4 = (() => K5124[0])();
var SHA512_Kl4 = (() => K5124[1])();
var SHA512_W_H4 = new Uint32Array(80);
var SHA512_W_L4 = new Uint32Array(80);
var SHA5124 = class extends HashMD4 {
  constructor(outputLen = 64) {
    super(128, outputLen, 16, false);
  ...
  process(view, offset) {
    for (let i3 = 0; i3 < 16; i3++, offset += 4) {
      SHA512_W_H4[i3] = view.getUint32(offset);
      SHA512_W_L4[i3] = view.getUint32(offset += 4);
    }
    for (let i3 = 16; i3 < 80; i3++) {
      const W15h = SHA512_W_H4[i3 - 15] | 0;
      const W15l = SHA512_W_L4[i3 - 15] | 0;
      ...
      const W2h = SHA512_W_H4[i3 - 2] | 0;
      const W2l = SHA512_W_L4[i3 - 2] | 0;
      ...
      const SUMl = add4L4(s0l, s1l, SHA512_W_L4[i3 - 7], SHA512_W_L4[i3 - 16]);
      const SUMh = add4H4(SUMl, s0h, s1h, SHA512_W_H4[i3 - 7], SHA512_W_H4[i3 - 16]);
      SHA512_W_H4[i3] = SUMh | 0;
      SHA512_W_L4[i3] = SUMl | 0;
    }
    let { Ah, Al, Bh, Bl, Ch, Cl, Dh, Dl, Eh, El, Fh, Fl, Gh, Gl, Hh, Hl } = this;
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const CHIh = Eh & Fh ^ ~Eh & Gh;
      const CHIl = El & Fl ^ ~El & Gl;
      const T1ll = add5L4(Hl, sigma1l, CHIl, SHA512_Kl4[i3], SHA512_W_L4[i3]);
      const T1h = add5H4(T1ll, Hh, sigma1h, CHIh, SHA512_Kh4[i3], SHA512_W_H4[i3]);
      const T1l = T1ll | 0;
...
var SHA3844 = class extends SHA5124 {
  constructor() {
    super(48);
    this.Ah = SHA384_IV4[0] | 0;
    this.Al = SHA384_IV4[1] | 0;
    this.Bh = SHA384_IV4[2] | 0;
    this.Bl = SHA384_IV4[3] | 0;
    this.Ch = SHA384_IV4[4] | 0;
    this.Cl = SHA384_IV4[5] | 0;
    this.Dh = SHA384_IV4[6] | 0;
    this.Dl = SHA384_IV4[7] | 0;
    this.Eh = SHA384_IV4[8] | 0;
    this.El = SHA384_IV4[9] | 0;
    this.Fh = SHA384_IV4[10] | 0;
    this.Fl = SHA384_IV4[11] | 0;
    this.Gh = SHA384_IV4[12] | 0;
    this.Gl = SHA384_IV4[13] | 0;
    this.Hh = SHA384_IV4[14] | 0;
    this.Hl = SHA384_IV4[15] | 0;
  }
};
var T224_IV4 = Uint32Array.from([
  2352822216,
  424955298,
  1944164710,
  2312950998,
...
var SHA512_2244 = class extends SHA5124 {
  constructor() {
    super(28);
    this.Ah = T224_IV4[0] | 0;
    this.Al = T224_IV4[1] | 0;
    this.Bh = T224_IV4[2] | 0;
    this.Bl = T224_IV4[3] | 0;
    this.Ch = T224_IV4[4] | 0;
    this.Cl = T224_IV4[5] | 0;
    this.Dh = T224_IV4[6] | 0;
    this.Dl = T224_IV4[7] | 0;
    this.Eh = T224_IV4[8] | 0;
    this.El = T224_IV4[9] | 0;
    this.Fh = T224_IV4[10] | 0;
    this.Fl = T224_IV4[11] | 0;
    this.Gh = T224_IV4[12] | 0;
    this.Gl = T224_IV4[13] | 0;
    this.Hh = T224_IV4[14] | 0;
    this.Hl = T224_IV4[15] | 0;
  }
};
var SHA512_2564 = class extends SHA5124 {
  constructor() {
    super(32);
    this.Ah = T256_IV4[0] | 0;
    this.Al = T256_IV4[1] | 0;
    this.Bh = T256_IV4[2] | 0;
    this.Bl = T256_IV4[3] | 0;
    this.Ch = T256_IV4[4] | 0;
    this.Cl = T256_IV4[5] | 0;
    this.Dh = T256_IV4[6] | 0;
    this.Dl = T256_IV4[7] | 0;
    this.Eh = T256_IV4[8] | 0;
    this.El = T256_IV4[9] | 0;
    this.Fh = T256_IV4[10] | 0;
    this.Fl = T256_IV4[11] | 0;
    this.Gh = T256_IV4[12] | 0;
    this.Gl = T256_IV4[13] | 0;
    this.Hh = T256_IV4[14] | 0;
    this.Hl = T256_IV4[15] | 0;
  }
};
var sha2566 = createHasher5(() => new SHA2564());
var sha2244 = createHasher5(() => new SHA2244());
var sha5124 = createHasher5(() => new SHA5124());
var sha3844 = createHasher5(() => new SHA3844());
var sha512_2564 = createHasher5(() => new SHA512_2564());
var sha512_2244 = createHasher5(() => new SHA512_2244());

// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/czech.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/english.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/french.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/italian.js
var wordlist4 = `abaco
abbaglio
abbinato
abete
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/japanese.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/korean.js
var wordlist6 = `가격
가끔
가난
가능
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/portuguese.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/simplified-chinese.js
var wordlist8 = `的
一
是
在
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/spanish.js
...
// node_modules/@base-org/account/node_modules/@scure/bip39/esm/wordlists/traditional-chinese.js
var wordlist10 = `的
一
是
在
...
//# sourceMappingURL=dist-TLQEHTPM.js.map
