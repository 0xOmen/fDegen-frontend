...
var noChange2 = /* @__PURE__ */ Symbol.for("lit-noChange");
...
var ICONS = {
  add: async () => (await import("./add-7SXOV6SI.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-5NNH4HQY.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-AACUFS4J.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5TEWZOXJ.js")).appStoreSvg,
  apple: async () => (await import("./apple-ZXSUFSOK.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-VXY6C6A3.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-3VRJQHBL.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-LCQO2OAI.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-7NDDK3RE.js")).arrowTopSvg,
  bank: async () => (await import("./bank-XIK2UFEX.js")).bankSvg,
  browser: async () => (await import("./browser-5LXQCO7J.js")).browserSvg,
  card: async () => (await import("./card-FE2MIBQX.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-3VUSM77Z.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-PUUMEQSG.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-IH5KAG23.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-VLAER33J.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-TA56UDEG.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-ML3DMJB5.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-YV6A4AMM.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-2R5DC3U6.js")).clockSvg,
  close: async () => (await import("./close-BDGDV75R.js")).closeSvg,
  compass: async () => (await import("./compass-QIPKAJLI.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-YTU3BVM3.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-I2QA5KCQ.js")).copySvg,
  cursor: async () => (await import("./cursor-RUBHLKKF.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-MSJCYLON.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-E5YLFSLI.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-NYLJAZUQ.js")).disconnectSvg,
  discord: async () => (await import("./discord-VRKRNUG4.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-QAQI2Y6F.js")).etherscanSvg,
  extension: async () => (await import("./extension-D4DY6X55.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-CFRCU4GD.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-XO3TRQFZ.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-JXP3H2AH.js")).farcasterSvg,
  filters: async () => (await import("./filters-5J6CPL5T.js")).filtersSvg,
  github: async () => (await import("./github-7NCVETZT.js")).githubSvg,
  google: async () => (await import("./google-MKF5P4OR.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-2B27J5K7.js")).helpCircleSvg,
  image: async () => (await import("./image-YUOLIWKH.js")).imageSvg,
  id: async () => (await import("./id-RBOQLPWH.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-2ZIVJEDO.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-IXGM7ABA.js")).lightbulbSvg,
  mail: async () => (await import("./mail-DPSMFPLZ.js")).mailSvg,
  mobile: async () => (await import("./mobile-EO3U7APL.js")).mobileSvg,
  more: async () => (await import("./more-W2CLN3HP.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-T44RFFB7.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-CCDH43O7.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-ISBDZ4NN.js")).offSvg,
  playStore: async () => (await import("./play-store-YCVUIP6W.js")).playStoreSvg,
  plus: async () => (await import("./plus-ESITLBEZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-QXTOR3GE.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-Z47S5RJF.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-KRJPU2KU.js")).refreshSvg,
  search: async () => (await import("./search-5D2IODOI.js")).searchSvg,
  send: async () => (await import("./send-WIF67NMY.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-D3ACQVHA.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-SZS33ZBG.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-NGJ7ORCT.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-MX2BWWIL.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-Y2XGCKJC.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-6F247KFF.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-WWHS7XUH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-INQYHZRM.js")).twitchSvg,
  twitter: async () => (await import("./x-FCYOZJGP.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-OCQBDICX.js")).twitterIconSvg,
  verify: async () => (await import("./verify-AKUT4EU4.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-EWYCRZQF.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-K65JBXIR.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-GVLXXSBY.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-GVLXXSBY.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-GVLXXSBY.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-BA6GZPQZ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-OFHECYJH.js")).warningCircleSvg,
  x: async () => (await import("./x-FCYOZJGP.js")).xSvg,
  info: async () => (await import("./info-D253VC55.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-Z2S6YUJG.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-J5G5Q7YC.js")).reownSvg
};
...
//# sourceMappingURL=chunk-MOPB2UTF.js.map
