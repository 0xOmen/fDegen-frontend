...
import {
  ...
  snapshot,
  subscribe
} from "./chunk-VGHVEPCQ.js";
import {
  esm_exports,
  require_cjs,
  require_cjs2,
  require_cjs3
} from "./chunk-SBOQJCTP.js";
import {
  formatUnits
} from "./chunk-IG6TNUJE.js";
import {
  require_events
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !(function(t, e) {
      ...
      "use strict";
      var t = 1e3, e = 6e4, n2 = 36e5, r2 = "millisecond", i3 = "second", s = "minute", u2 = "hour", a = "day", o2 = "week", c = "month", f6 = "quarter", h3 = "year", d2 = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y3 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t2) {
        ...
        var e2 = -t2.utcOffset(), n3 = Math.abs(e2), r3 = Math.floor(n3 / 60), i4 = n3 % 60;
        return (e2 <= 0 ? "+" : "-") + m2(r3, 2, "0") + ":" + m2(i4, 2, "0");
      }, m: function t2(e2, n3) {
        if (e2.date() < n3.date()) return -t2(n3, e2);
        var r3 = 12 * (n3.year() - e2.year()) + (n3.month() - e2.month()), i4 = e2.clone().add(r3, c), s2 = n3 - i4 < 0, u3 = e2.clone().add(r3 + (s2 ? -1 : 1), c);
        return +(-(r3 + (n3 - i4) / (s2 ? i4 - u3 : u3 - i4)) || 0);
      }, a: function(t2) {
        return t2 < 0 ? Math.ceil(t2) || 0 : Math.floor(t2);
      }, p: function(t2) {
        return { M: c, y: h3, w: o2, d: a, D: d2, h: u2, m: s, s: i3, ms: r2, Q: f6 }[t2] || String(t2 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t2) {
        return void 0 === t2;
      } }, g = "en", D = {};
      D[g] = M3;
      var p = "$isDayjsObject", S2 = function(t2) {
        ...
        if ("string" == typeof e2) {
          ...
          D[s2] && (i4 = s2), n3 && (D[s2] = n3, i4 = s2);
          var u3 = e2.split("-");
          if (!i4 && u3.length > 1) return t2(u3[0]);
        } else {
          var a2 = e2.name;
          D[a2] = e2, i4 = a2;
        }
        ...
        return m3.parse = function(t2) {
          this.$d = (function(t3) {
            ...
            if ("string" == typeof e2 && !/Z$/i.test(e2)) {
              var r3 = e2.match($);
              if (r3) {
                var i4 = r3[2] - 1 || 0, s2 = (r3[7] || "0").substring(0, 3);
                return n3 ? new Date(Date.UTC(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s2)) : new Date(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s2);
              }
            }
            return new Date(e2);
          })(t2), this.init();
          ...
          var n3 = this, r3 = !!b.u(e2) || e2, f7 = b.p(t2), l3 = function(t3, e3) {
            var i4 = b.w(n3.$u ? Date.UTC(n3.$y, e3, t3) : new Date(n3.$y, e3, t3), n3);
            return r3 ? i4 : i4.endOf(a);
          }, $2 = function(t3, e3) {
            return b.w(n3.toDate()[t3].apply(n3.toDate("s"), (r3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e3)), n3);
          }, y4 = this.$W, M5 = this.$M, m4 = this.$D, v2 = "set" + (this.$u ? "UTC" : "");
          switch (f7) {
            case h3:
            ...
            case o2:
              var g2 = this.$locale().weekStart || 0, D2 = (y4 < g2 ? y4 + 7 : y4) - g2;
              return l3(r3 ? m4 - D2 : m4 + (6 - D2), M5);
            case a:
            case d2:
              return $2(v2 + "Hours", 0);
            case u2:
          ...
          var n3, o3 = b.p(t2), f7 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a] = f7 + "Date", n3[d2] = f7 + "Date", n3[c] = f7 + "Month", n3[h3] = f7 + "FullYear", n3[u2] = f7 + "Hours", n3[s] = f7 + "Minutes", n3[i3] = f7 + "Seconds", n3[r2] = f7 + "Milliseconds", n3)[o3], $2 = o3 === a ? this.$D + (e2 - this.$W) : e2;
          if (o3 === c || o3 === h3) {
            var y4 = this.clone().set(d2, 1);
            y4.$d[l3]($2), y4.init(), this.$d = y4.set(d2, Math.min(this.$D, y4.daysInMonth())).$d;
          } else l3 && this.$d[l3]($2);
          ...
          var d3, l3 = this;
          r3 = Number(r3);
          var $2 = b.p(f7), y4 = function(t2) {
            var e2 = O2(l3);
            return b.w(e2.date(e2.date() + Math.round(t2 * r3)), l3);
          };
          if ($2 === c) return this.set(c, this.$M + r3);
          if ($2 === h3) return this.set(h3, this.$y + r3);
          if ($2 === a) return y4(1);
          if ($2 === o2) return y4(7);
          var M5 = (d3 = {}, d3[s] = e, d3[u2] = n2, d3[i3] = t, d3)[$2] || 1, m4 = this.$d.getTime() + r3 * M5;
          return b.w(m4, this);
          ...
          var r3 = t2 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b.z(this), s2 = this.$H, u3 = this.$m, a2 = this.$M, o3 = n3.weekdays, c2 = n3.months, f7 = n3.meridiem, h4 = function(t3, n4, i5, s3) {
            return t3 && (t3[n4] || t3(e2, r3)) || i5[n4].slice(0, s3);
          }, d3 = function(t3) {
            return b.s(s2 % 12 || 12, t3, "0");
          }, $2 = f7 || function(t3, e3, n4) {
            var r4 = t3 < 12 ? "AM" : "PM";
            ...
            return r4 || (function(t4) {
              switch (t4) {
                ...
                case "MM":
                  return b.s(a2 + 1, 2, "0");
                case "MMM":
                  return h4(n3.monthsShort, a2, c2, 3);
                case "MMMM":
                  return h4(c2, a2);
                case "D":
                  return e2.$D;
                ...
                case "d":
                  return String(e2.$W);
                case "dd":
                  return h4(n3.weekdaysMin, e2.$W, o3, 2);
                case "ddd":
                  return h4(n3.weekdaysShort, e2.$W, o3, 3);
                case "dddd":
                  return o3[e2.$W];
                case "H":
                  return String(s2);
          ...
          var $2, y4 = this, M5 = b.p(d3), m4 = O2(r3), v2 = (m4.utcOffset() - this.utcOffset()) * e, g2 = this - m4, D2 = function() {
            return b.m(y4, m4);
          };
          switch (M5) {
            case h3:
      ...
      return O2.prototype = k2, [["$ms", r2], ["$s", i3], ["$m", s], ["$H", u2], ["$W", a], ["$M", c], ["$y", h3], ["$D", d2]].forEach((function(t2) {
        k2[t2[1]] = function(e2) {
  ...
  "node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !(function(r2, e) {
      ...
      return function(r2, e, t) {
        ...
        function i3(r3, e2, t2, o3) {
          return n2.fromToBase(r3, e2, t2, o3);
        }
        t.en.relativeTime = o2, n2.fromToBase = function(e2, n3, i4, d3, u2) {
          for (var f6, a, s, l2 = i4.$locale().relativeTime || o2, h3 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h3.length, c = 0; c < m2; c += 1) {
            var y3 = h3[c];
            y3.d && (f6 = d3 ? t(e2).diff(i4, y3.d, true) : i4.diff(e2, y3.d, true));
            var p = (r2.rounding || Math.round)(Math.abs(f6));
            if (s = f6 > 0, p <= y3.r || !y3.r) {
              p <= 1 && c > 0 && (y3 = h3[c - 1]);
              var v = l2[y3.l];
              u2 && (p = u2("" + p)), a = "string" == typeof v ? v.replace("%d", p) : v(p, n3, y3.l, s);
              break;
            }
          }
          if (n3) return a;
          var M3 = s ? l2.future : l2.past;
...
function stringify(x, doExponential, isNonzero) {
  var e = x.e, s = x.c.join(""), n2 = s.length;
  if (doExponential) {
...
P.cmp = function(y3) {
  var isneg, x = this, xc2 = x.c, yc2 = (y3 = new x.constructor(y3)).c, i3 = x.s, j = y3.s, k2 = x.e, l2 = y3.e;
...
P.div = function(y3) {
  var x = this, Big2 = x.constructor, a = x.c, b = (y3 = new Big2(y3)).c, k2 = x.s == y3.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt2, n2, cmp, ri3, bz = b.slice(), ai2 = bl = b.length, al = a.length, r2 = a.slice(0, bl), rl = r2.length, q2 = y3, qc2 = q2.c = [], qi2 = 0, p = dp + (q2.e = x.e - y3.e) + 1;
  q2.s = k2;
  k2 = p < 0 ? 0 : p;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
...
P.minus = P.sub = function(y3) {
  var i3, j, t, xlty, x = this, Big2 = x.constructor, a = x.s, b = (y3 = new Big2(y3)).s;
  if (a != b) {
    y3.s = -b;
    return x.plus(y3);
  }
  var xc2 = x.c.slice(), xe2 = x.e, yc2 = y3.c, ye2 = y3.e;
  if (!xc2[0] || !yc2[0]) {
    if (yc2[0]) {
      y3.s = -b;
    } else if (xc2[0]) {
...
P.mod = function(y3) {
  var ygtx, x = this, Big2 = x.constructor, a = x.s, b = (y3 = new Big2(y3)).s;
  if (!y3.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x.s = y3.s = 1;
...
P.plus = P.add = function(y3) {
  var e, k2, t, x = this, Big2 = x.constructor;
  y3 = new Big2(y3);
  if (x.s != y3.s) {
    y3.s = -y3.s;
    return x.minus(y3);
  }
  var xe2 = x.e, xc2 = x.c, ye2 = y3.e, yc2 = y3.c;
  if (!xc2[0] || !yc2[0]) {
    if (!yc2[0]) {
      if (xc2[0]) {
        y3 = new Big2(x);
...
P.pow = function(n2) {
  var x = this, one = new x.constructor("1"), y3 = one, isneg = n2 < 0;
  if (n2 !== ~~n2 || n2 < -MAX_POWER || n2 > MAX_POWER) {
    throw Error(INVALID + "exponent");
  }
  if (isneg) n2 = -n2;
  for (; ; ) {
    if (n2 & 1) y3 = y3.times(x);
    n2 >>= 1;
    if (!n2) break;
    x = x.times(x);
  }
...
P.sqrt = function() {
  ...
  if (s === 0 || s === 1 / 0) {
    ...
    s = Math.sqrt(c);
    e = ((e + 1) / 2 | 0) - (e < 0 || e & 1);
    r2 = new Big2((s == 1 / 0 ? "5e" : (s = s.toExponential()).slice(0, s.indexOf("e") + 1)) + e);
  } else {
    r2 = new Big2(s + "");
  }
  e = r2.e + (Big2.DP += 4);
...
P.times = P.mul = function(y3) {
  var c, x = this, Big2 = x.constructor, xc2 = x.c, yc2 = (y3 = new Big2(y3)).c, a = xc2.length, b = yc2.length, i3 = x.e, j = y3.e;
  y3.s = x.s == y3.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y3.c = [y3.e = 0];
    return y3;
...
var controller8 = {
  ...
  getUniqueConnectorsByName(connectors) {
    ...
    connectors.forEach((c) => {
      if (!uniqueConnectors.find((uc2) => uc2.chain === c.chain)) {
  ...
  getAuthConnector(chainNamespace) {
    ...
    const authConnector = state14.connectors.find((c) => c.id === ConstantsUtil.CONNECTOR_ID.AUTH);
    if (!authConnector) {
      return void 0;
    }
  ...
  getAnnouncedConnectorRdns() {
    return state14.connectors.filter((c) => c.type === "ANNOUNCED").map((c) => c.info?.rdns);
  },
  getConnectorById(id) {
    return state14.allConnectors.find((c) => c.id === id);
  },
  getConnector(id, rdns) {
    const connectorsByNamespace = state14.allConnectors.filter((c) => c.chain === ChainController.state.activeChain);
...
function Zi(t, e = 24) {
  ...
  for (let r2 = 24 - e; r2 < 24; r2++) {
    ...
    for (let s = 0; s < 10; s += 2) {
      const c = (s + 8) % 10, a = (s + 2) % 10, u2 = n2[a], l2 = n2[a + 1], f6 = rr(u2, l2, 1) ^ n2[c], h3 = or(u2, l2, 1) ^ n2[c + 1];
      for (let y3 = 0; y3 < 50; y3 += 10) t[s + y3] ^= f6, t[s + y3 + 1] ^= h3;
    }
    let o2 = t[2], i3 = t[3];
    for (let s = 0; s < 24; s++) {
      const c = er[s], a = rr(o2, i3, c), u2 = or(o2, i3, c), l2 = tr[s];
      o2 = t[l2], i3 = t[l2 + 1], t[l2] = a, t[l2 + 1] = u2;
    }
    for (let s = 0; s < 50; s += 10) {
      for (let c = 0; c < 10; c++) n2[c] = t[s + c];
      for (let c = 0; c < 10; c++) t[s + c] ^= ~n2[(c + 2) % 10] & n2[(c + 4) % 10];
    }
    t[0] ^= Fi[r2], t[1] ^= zi[r2];
  }
  n2.fill(0);
...
var En = class _En extends ke {
  ...
  update(e) {
    ...
    for (let i3 = 0; i3 < o2; ) {
      ...
      for (let c = 0; c < s; c++) r2[this.pos++] ^= e[i3++];
...
var Es = (t, e) => {
  function n2(r2, ...o2) {
    ...
    return { encrypt(l2, f6) {
      ...
      return a = true, tt(l2), c(s.encrypt.length, f6), s.encrypt(l2, f6);
    }, decrypt(l2, f6) {
      if (tt(l2), i3 && l2.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c(s.decrypt.length, f6), s.decrypt(l2, f6);
    } };
  }
...
function Ir(t, e, n2, r2) {
  ...
  const o2 = BigInt(32), i3 = BigInt(4294967295), s = Number(n2 >> o2 & i3), c = Number(n2 & i3), a = r2 ? 4 : 0, u2 = r2 ? 0 : 4;
  t.setUint32(e + a, s, r2), t.setUint32(e + u2, c, r2);
}
function vs(t) {
...
function Is(t, e, n2, r2, o2, i3, s, c) {
  const a = o2.length, u2 = new Uint8Array(ge), l2 = mt(u2), f6 = Ye(o2) && Ye(i3), h3 = f6 ? mt(o2) : Tr, y3 = f6 ? mt(i3) : Tr;
  for (let E2 = 0; E2 < a; s++) {
    if (t(e, n2, r2, l2, s, c), s >= Ur) throw new Error("arx: counter overflow");
    const p = Math.min(ge, a - E2);
    if (f6 && p === ge) {
      const d2 = E2 / 4;
      if (E2 % 4 !== 0) throw new Error("arx: invalid block position");
      for (let v = 0, m2; v < Bs; v++) m2 = d2 + v, y3[m2] = h3[m2] ^ l2[v];
      E2 += ge;
      continue;
    }
...
function Ns(t, e) {
  ...
  return Fe(o2), Fe(s), Ar(i3), Ar(n2), (c, a, u2, l2, f6 = 0) => {
    tt(c), tt(a), tt(u2);
    const h3 = u2.length;
    if (l2 === void 0 && (l2 = new Uint8Array(h3)), tt(l2), Fe(f6), f6 < 0 || f6 >= Ur) throw new Error("arx: counter overflow");
    if (l2.length < h3) throw new Error(`arx: output (${l2.length}) is shorter than data (${h3})`);
    const y3 = [];
    let E2 = c.length, p, d2;
    if (E2 === 32) y3.push(p = Ze(c)), d2 = As;
    else if (E2 === 16 && n2) p = new Uint8Array(32), p.set(c), p.set(c, 16), d2 = Os, y3.push(p);
    ...
    if (m2 !== 12) {
      ...
      N.set(a, i3 ? 0 : 12 - a.length), a = N, y3.push(a);
    }
    const O2 = mt(a);
    return Is(t, d2, v, O2, u2, l2, f6, s), jt(...y3), l2;
  };
}
...
var Us = class {
  constructor(e) {
    ...
    const n2 = F(e, 0), r2 = F(e, 2), o2 = F(e, 4), i3 = F(e, 6), s = F(e, 8), c = F(e, 10), a = F(e, 12), u2 = F(e, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o2 << 6) & 7939, this.r[3] = (o2 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s << 12) & 255, this.r[5] = s >>> 1 & 8190, this.r[6] = (s >>> 14 | c << 2) & 8191, this.r[7] = (c >>> 11 | a << 5) & 8065, this.r[8] = (a >>> 8 | u2 << 8) & 8191, this.r[9] = u2 >>> 5 & 127;
    for (let l2 = 0; l2 < 8; l2++) this.pad[l2] = F(e, 16 + 2 * l2);
  }
  process(e, n2, r2 = false) {
    const o2 = r2 ? 0 : 2048, { h: i3, r: s } = this, c = s[0], a = s[1], u2 = s[2], l2 = s[3], f6 = s[4], h3 = s[5], y3 = s[6], E2 = s[7], p = s[8], d2 = s[9], v = F(e, n2 + 0), m2 = F(e, n2 + 2), O2 = F(e, n2 + 4), N = F(e, n2 + 6), $ = F(e, n2 + 8), B3 = F(e, n2 + 10), A2 = F(e, n2 + 12), T = F(e, n2 + 14);
    let S2 = i3[0] + (v & 8191), L = i3[1] + ((v >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O2 << 6) & 8191), _ = i3[3] + ((O2 >>> 7 | N << 9) & 8191), j = i3[4] + ((N >>> 4 | $ << 12) & 8191), g = i3[5] + ($ >>> 1 & 8191), w = i3[6] + (($ >>> 14 | B3 << 2) & 8191), b = i3[7] + ((B3 >>> 11 | A2 << 5) & 8191), I2 = i3[8] + ((A2 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o2), x = 0, C4 = x + S2 * c + L * (5 * d2) + U4 * (5 * p) + _ * (5 * E2) + j * (5 * y3);
    x = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h3) + w * (5 * f6) + b * (5 * l2) + I2 * (5 * u2) + R3 * (5 * a), x += C4 >>> 13, C4 &= 8191;
    let P4 = x + S2 * a + L * c + U4 * (5 * d2) + _ * (5 * p) + j * (5 * E2);
    x = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y3) + w * (5 * h3) + b * (5 * f6) + I2 * (5 * l2) + R3 * (5 * u2), x += P4 >>> 13, P4 &= 8191;
    let k2 = x + S2 * u2 + L * a + U4 * c + _ * (5 * d2) + j * (5 * p);
    x = k2 >>> 13, k2 &= 8191, k2 += g * (5 * E2) + w * (5 * y3) + b * (5 * h3) + I2 * (5 * f6) + R3 * (5 * l2), x += k2 >>> 13, k2 &= 8191;
    let M3 = x + S2 * l2 + L * u2 + U4 * a + _ * c + j * (5 * d2);
    x = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p) + w * (5 * E2) + b * (5 * y3) + I2 * (5 * h3) + R3 * (5 * f6), x += M3 >>> 13, M3 &= 8191;
    let D = x + S2 * f6 + L * l2 + U4 * u2 + _ * a + j * c;
    x = D >>> 13, D &= 8191, D += g * (5 * d2) + w * (5 * p) + b * (5 * E2) + I2 * (5 * y3) + R3 * (5 * h3), x += D >>> 13, D &= 8191;
    let z = x + S2 * h3 + L * f6 + U4 * l2 + _ * u2 + j * a;
    x = z >>> 13, z &= 8191, z += g * c + w * (5 * d2) + b * (5 * p) + I2 * (5 * E2) + R3 * (5 * y3), x += z >>> 13, z &= 8191;
    let Z2 = x + S2 * y3 + L * h3 + U4 * f6 + _ * l2 + j * u2;
    x = Z2 >>> 13, Z2 &= 8191, Z2 += g * a + w * c + b * (5 * d2) + I2 * (5 * p) + R3 * (5 * E2), x += Z2 >>> 13, Z2 &= 8191;
    let st2 = x + S2 * E2 + L * y3 + U4 * h3 + _ * f6 + j * l2;
    x = st2 >>> 13, st2 &= 8191, st2 += g * u2 + w * a + b * c + I2 * (5 * d2) + R3 * (5 * p), x += st2 >>> 13, st2 &= 8191;
    let W = x + S2 * p + L * E2 + U4 * y3 + _ * h3 + j * f6;
    x = W >>> 13, W &= 8191, W += g * l2 + w * u2 + b * a + I2 * c + R3 * (5 * d2), x += W >>> 13, W &= 8191;
    let J2 = x + S2 * d2 + L * p + U4 * E2 + _ * y3 + j * h3;
    x = J2 >>> 13, J2 &= 8191, J2 += g * f6 + w * l2 + b * u2 + I2 * a + R3 * c, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P4 += x, i3[0] = C4, i3[1] = P4, i3[2] = k2, i3[3] = M3, i3[4] = D, i3[5] = z, i3[6] = Z2, i3[7] = st2, i3[8] = W, i3[9] = J2;
  }
  finalize() {
    ...
    r2[9] -= 8192;
    let i3 = (o2 ^ 1) - 1;
    for (let c = 0; c < 10; c++) r2[c] &= i3;
    i3 = ~i3;
    for (let c = 0; c < 10; c++) e[c] = e[c] & i3 | r2[c];
    e[0] = (e[0] | e[1] << 13) & 65535, e[1] = (e[1] >>> 3 | e[2] << 10) & 65535, e[2] = (e[2] >>> 6 | e[3] << 7) & 65535, e[3] = (e[3] >>> 9 | e[4] << 4) & 65535, e[4] = (e[4] >>> 12 | e[5] << 1 | e[6] << 14) & 65535, e[5] = (e[6] >>> 2 | e[7] << 11) & 65535, e[6] = (e[7] >>> 5 | e[8] << 8) & 65535, e[7] = (e[8] >>> 8 | e[9] << 5) & 65535;
    let s = e[0] + n2[0];
    e[0] = s & 65535;
    for (let c = 1; c < 8; c++) s = (e[c] + n2[c] | 0) + (s >>> 16) | 0, e[c] = s & 65535;
    jt(r2);
  }
  update(e) {
    Or(this);
...
function _s(t, e, n2, r2, o2, i3 = 20) {
  let s = t[0], c = t[1], a = t[2], u2 = t[3], l2 = e[0], f6 = e[1], h3 = e[2], y3 = e[3], E2 = e[4], p = e[5], d2 = e[6], v = e[7], m2 = o2, O2 = n2[0], N = n2[1], $ = n2[2], B3 = s, A2 = c, T = a, S2 = u2, L = l2, U4 = f6, _ = h3, j = y3, g = E2, w = p, b = d2, I2 = v, R3 = m2, x = O2, C4 = N, P4 = $;
  ...
  let k2 = 0;
  r2[k2++] = s + B3 | 0, r2[k2++] = c + A2 | 0, r2[k2++] = a + T | 0, r2[k2++] = u2 + S2 | 0, r2[k2++] = l2 + L | 0, r2[k2++] = f6 + U4 | 0, r2[k2++] = h3 + _ | 0, r2[k2++] = y3 + j | 0, r2[k2++] = E2 + g | 0, r2[k2++] = p + w | 0, r2[k2++] = d2 + b | 0, r2[k2++] = v + I2 | 0, r2[k2++] = m2 + R3 | 0, r2[k2++] = O2 + x | 0, r2[k2++] = N + C4 | 0, r2[k2++] = $ + P4 | 0;
}
...
function _r(t, e, n2, r2, o2) {
  ...
  Ir(a, 0, BigInt(o2 ? o2.length : 0), true), Ir(a, 8, BigInt(r2.length), true), s.update(c);
  const u2 = s.digest();
  return jt(i3, c), u2;
}
var Cs = (t) => (e, n2, r2) => ({ encrypt(i3, s) {
  const c = i3.length;
  s = Br(c + 16, s, false), s.set(i3);
  const a = s.subarray(0, -16);
  t(e, n2, a, a, 1);
  const u2 = _r(t, e, n2, a, r2);
  return s.set(u2, c), jt(u2), s;
}, decrypt(i3, s) {
  s = Br(i3.length - 16, s, false);
  const c = i3.subarray(0, -16), a = i3.subarray(-16), u2 = _r(t, e, n2, c, r2);
  if (!bs(a, u2)) throw new Error("invalid tag");
  return s.set(i3.subarray(0, -16)), t(e, n2, s, s, 1), jt(u2), s;
} });
...
var Lr = class extends ke {
  ...
  _cloneInto(e) {
    ...
    const { oHash: n2, iHash: r2, finished: o2, destroyed: i3, blockLen: s, outputLen: c } = this;
    return e = e, e.finished = o2, e.destroyed = i3, e.blockLen = s, e.outputLen = c, e.oHash = n2._cloneInto(e.oHash), e.iHash = r2._cloneInto(e.iHash), e;
  }
  destroy() {
...
var qs = class extends ke {
  ...
  update(e) {
    ...
    const i3 = e.length;
    for (let s = 0; s < i3; ) {
      const c = Math.min(o2 - this.pos, i3 - s);
      if (c === o2) {
        const a = Pe(e);
        for (; o2 <= i3 - s; s += o2) this.process(a, s);
        continue;
      }
      r2.set(e.subarray(s, s + c), this.pos), this.pos += c, s += c, this.pos === o2 && (this.process(n2, 0), this.pos = 0);
    }
  ...
  digestInto(e) {
    ...
    const u2 = a / 4, l2 = this.get();
    if (u2 > l2.length) throw new Error("_sha2: outputLen bigger than state");
    for (let f6 = 0; f6 < u2; f6++) c.setUint32(4 * f6, l2[f6], i3);
  }
  digest() {
    const { buffer: e, outputLen: n2 } = this;
    this.digestInto(e);
  ...
  _cloneInto(e) {
    ...
    const { blockLen: n2, buffer: r2, length: o2, finished: i3, destroyed: s, pos: c } = this;
    return e.length = o2, e.pos = c, e.finished = i3, e.destroyed = s, o2 % n2 && e.buffer.set(r2), e;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e, B: n2, C: r2, D: o2, E: i3, F: s, G: c, H: a } = this;
    return [e, n2, r2, o2, i3, s, c, a];
  }
  set(e, n2, r2, o2, i3, s, c, a) {
    this.A = e | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o2 | 0, this.E = i3 | 0, this.F = s | 0, this.G = c | 0, this.H = a | 0;
  }
  process(e, n2) {
    for (let f6 = 0; f6 < 16; f6++, n2 += 4) bt[f6] = e.getUint32(n2, false);
    for (let f6 = 16; f6 < 64; f6++) {
      const h3 = bt[f6 - 15], y3 = bt[f6 - 2], E2 = ct(h3, 7) ^ ct(h3, 18) ^ h3 >>> 3, p = ct(y3, 17) ^ ct(y3, 19) ^ y3 >>> 10;
      bt[f6] = p + bt[f6 - 7] + E2 + bt[f6 - 16] | 0;
    }
    let { A: r2, B: o2, C: i3, D: s, E: c, F: a, G: u2, H: l2 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h3 = ct(c, 6) ^ ct(c, 11) ^ ct(c, 25), y3 = l2 + h3 + Ds(c, a, u2) + Ks[f6] + bt[f6] | 0, p = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o2, i3) | 0;
      l2 = u2, u2 = a, a = c, c = s + y3 | 0, s = i3, i3 = o2, o2 = r2, r2 = y3 + p | 0;
    }
    r2 = r2 + this.A | 0, o2 = o2 + this.B | 0, i3 = i3 + this.C | 0, s = s + this.D | 0, c = c + this.E | 0, a = a + this.F | 0, u2 = u2 + this.G | 0, l2 = l2 + this.H | 0, this.set(r2, o2, i3, s, c, a, u2, l2);
  }
  roundClean() {
    bt.fill(0);
  }
...
function Vt(t) {
  ...
  for (let o2 = 0, i3 = 0; o2 < n2; o2++, i3 += 2) {
    const s = Cr(t.charCodeAt(i3)), c = Cr(t.charCodeAt(i3 + 1));
...
function Vr(t, e, n2) {
  ...
  let r2 = Qe(t), o2 = Qe(t), i3 = 0;
  const s = () => {
    r2.fill(1), o2.fill(0), i3 = 0;
  }, c = (...f6) => n2(o2, r2, ...f6), a = (f6 = Qe()) => {
    o2 = c(kr([0]), f6), r2 = c(), f6.length !== 0 && (o2 = c(kr([1]), f6), r2 = c());
  }, u2 = () => {
...
function Dt(t, e, n2 = {}) {
  const r2 = (o2, i3, s) => {
    ...
    const a = t[o2];
    if (!(s && a === void 0) && !c(a, t)) throw new Error("param " + String(o2) + " is invalid. Expected " + i3 + ", got " + a);
  };
...
function nn(t, e) {
  ...
  for (; n2 !== q; ) {
    const c = r2 / n2, a = r2 % n2, u2 = o2 - i3 * c;
...
function rc(t) {
  ...
  if (r2 === 1) {
    ...
    return function(a, u2) {
      const l2 = a.pow(u2, s);
      if (!a.eql(a.sqr(l2), u2)) throw new Error("Cannot find square root");
      return l2;
    };
  }
  const i3 = (n2 + H) / At;
  return function(c, a) {
    ...
    let u2 = r2, l2 = c.pow(c.mul(c.ONE, o2), n2), f6 = c.pow(a, i3), h3 = c.pow(a, n2);
    for (; !c.eql(h3, c.ONE); ) {
      if (c.eql(h3, c.ZERO)) return c.ZERO;
      let y3 = 1;
      for (let p = c.sqr(h3); y3 < u2 && !c.eql(p, c.ONE); y3++) p = c.sqr(p);
      const E2 = c.pow(l2, H << BigInt(u2 - y3 - 1));
      l2 = c.sqr(E2), f6 = c.mul(f6, E2), h3 = c.mul(h3, l2), u2 = y3;
    }
    return f6;
  };
}
function oc(t) {
  ...
  if (t % Dr === Mr) {
    const e = (t - Mr) / Dr;
    return function(r2, o2) {
      const i3 = r2.mul(o2, At), s = r2.pow(i3, e), c = r2.mul(o2, s), a = r2.mul(r2.mul(c, At), s), u2 = r2.mul(c, r2.sub(a, r2.ONE));
...
function ac(t, e) {
  const n2 = new Array(e.length), r2 = e.reduce((i3, s, c) => t.is0(s) ? i3 : (n2[c] = i3, t.mul(i3, s)), t.ONE), o2 = t.inv(r2);
  return e.reduceRight((i3, s, c) => t.is0(s) ? i3 : (n2[c] = t.mul(i3, n2[c]), t.mul(i3, s)), o2), n2;
}
function qr(t, e) {
...
function Kr2(t, e, n2 = false, r2 = {}) {
  ...
  let s;
  const c = Object.freeze({ ORDER: t, isLE: n2, BITS: o2, BYTES: i3, MASK: Je(o2), ZERO: q, ONE: H, create: (a) => X(a, t), isValid: (a) => {
    if (typeof a != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a);
    return q <= a && a < t;
  }, is0: (a) => a === q, isOdd: (a) => (a & H) === H, neg: (a) => X(-a, t), eql: (a, u2) => a === u2, sqr: (a) => X(a * a, t), add: (a, u2) => X(a + u2, t), sub: (a, u2) => X(a - u2, t), mul: (a, u2) => X(a * u2, t), pow: (a, u2) => cc(c, a, u2), div: (a, u2) => X(a * nn(u2, t), t), sqrN: (a) => a * a, addN: (a, u2) => a + u2, subN: (a, u2) => a - u2, mulN: (a, u2) => a * u2, inv: (a) => nn(a, t), sqrt: r2.sqrt || ((a) => (s || (s = oc(t)), s(c, a))), invertBatch: (a) => ac(c, a), cmov: (a, u2, l2) => l2 ? u2 : a, toBytes: (a) => n2 ? be(a, i3) : Mt(a, i3), fromBytes: (a) => {
...
function uc(t, e, n2 = false) {
  ...
  const s = n2 ? ee(t) : Ot(t), c = X(s, e - H) + H;
  return n2 ? be(c, o2) : Mt(c, o2);
}
var Zr = BigInt(0);
var ve = BigInt(1);
function rn(t, e) {
...
function dc(t, e) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    ...
    for (let u2 = 0; u2 < o2; u2++) {
      a = c, s.push(a);
      for (let l2 = 1; l2 < i3; l2++) a = a.add(c), s.push(a);
      c = a.double();
    }
    return s;
  }, wNAF(n2, r2, o2) {
    ...
    const u2 = BigInt(2 ** n2 - 1), l2 = 2 ** n2, f6 = BigInt(n2);
    for (let h3 = 0; h3 < i3; h3++) {
      const y3 = h3 * s;
      let E2 = Number(o2 & u2);
      o2 >>= f6, E2 > s && (E2 -= l2, o2 += ve);
      const p = y3, d2 = y3 + Math.abs(E2) - 1, v = h3 % 2 !== 0, m2 = E2 < 0;
      E2 === 0 ? a = a.add(rn(v, r2[p])) : c = c.add(rn(m2, r2[d2]));
    }
    return { p: c, f: a };
  }, wNAFUnsafe(n2, r2, o2, i3 = t.ZERO) {
    const { windows: s, windowSize: c } = on(n2, e), a = BigInt(2 ** n2 - 1), u2 = 2 ** n2, l2 = BigInt(n2);
    for (let f6 = 0; f6 < s; f6++) {
      const h3 = f6 * c;
      if (o2 === Zr) break;
      let y3 = Number(o2 & a);
      if (o2 >>= l2, y3 > c && (y3 -= u2, o2 += ve), y3 === 0) continue;
...
function hc(t, e, n2, r2) {
  ...
  const o2 = t.ZERO, i3 = Pr(BigInt(n2.length)), s = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c = (1 << s) - 1, a = new Array(c + 1).fill(o2), u2 = Math.floor((e.BITS - 1) / s) * s;
  let l2 = o2;
  for (let f6 = u2; f6 >= 0; f6 -= s) {
    a.fill(o2);
    for (let y3 = 0; y3 < r2.length; y3++) {
      const E2 = r2[y3], p = Number(E2 >> BigInt(f6) & BigInt(c));
      a[p] = a[p].add(n2[y3]);
    }
    let h3 = o2;
    for (let y3 = a.length - 1, E2 = o2; y3 > 0; y3--) E2 = E2.add(a[y3]), h3 = h3.add(E2);
    if (l2 = l2.add(h3), f6 !== 0) for (let y3 = 0; y3 < s; y3++) l2 = l2.double();
  }
  return l2;
}
function Wr(t) {
...
function gc(t) {
  const e = pc(t), { P: n2 } = e, r2 = (m2) => X(m2, n2), o2 = e.montgomeryBits, i3 = Math.ceil(o2 / 8), s = e.nByteLength, c = e.adjustScalarBytes || ((m2) => m2), a = e.powPminus2 || ((m2) => Hr(m2, n2 - BigInt(2), n2));
  function u2(m2, O2, N) {
    const $ = r2(m2 * (O2 - N));
  ...
  function f6(m2, O2) {
    ...
    for (let j = BigInt(o2 - 1); j >= Ht; j--) {
      ...
      T = r2(D * D), S2 = r2($ * r2(z * z)), B3 = r2(b * R3), A2 = r2(x * (b + r2(l2 * x)));
    }
...
BigInt(8);
function bc(t) {
  const e = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), i3 = un, c = t * t % i3 * t % i3, a = it(c, Xr, i3) * c % i3, u2 = it(a, yc, i3) * t % i3, l2 = it(u2, wc, i3) * u2 % i3, f6 = it(l2, e, i3) * l2 % i3, h3 = it(f6, n2, i3) * f6 % i3, y3 = it(h3, r2, i3) * h3 % i3, E2 = it(y3, o2, i3) * y3 % i3, p = it(E2, o2, i3) * y3 % i3, d2 = it(p, e, i3) * l2 % i3;
  return { pow_p_5_8: it(d2, Xr, i3) * t % i3, b2: c };
}
function Ec(t) {
...
var lt = { Err: Oc, _tlv: { encode: (t, e) => {
  ...
  if (!i3) s = o2;
    ...
    if (r2 += a, s < 128) throw new n2("tlv.decode(long): not minimal encoding");
  }
  const c = e.subarray(r2, r2 + s);
  if (c.length !== s) throw new n2("tlv.decode: wrong value length");
  return { v: c, l: e.subarray(r2 + s) };
} }, _int: { encode(t) {
  const { Err: e } = lt;
  ...
  const { v: c, l: a } = r2.decode(2, i3), { v: u2, l: l2 } = r2.decode(2, a);
  if (l2.length) throw new e("invalid signature: left bytes after parsing");
  return { r: n2.decode(c), s: n2.decode(u2) };
}, hexFromSig(t) {
...
BigInt(4);
function Ac(t) {
  const e = vc(t), { Fp: n2 } = e, r2 = Kr2(e.n, e.nBitLength), o2 = e.toBytes || ((p, d2, v) => {
  ...
  function u2(p) {
    if (!(p instanceof h3)) throw new Error("ProjectivePoint expected");
  }
  const l2 = tn((p, d2) => {
  ...
  class h3 {
    ...
    static fromAffine(d2) {
      ...
      if (d2 instanceof h3) throw new Error("projective point not allowed");
      const O2 = (N) => n2.eql(N, n2.ZERO);
      return O2(v) && O2(m2) ? h3.ZERO : new h3(v, m2, n2.ONE);
    }
    get x() {
    ...
    static normalizeZ(d2) {
      ...
      return d2.map((m2, O2) => m2.toAffine(v[O2])).map(h3.fromAffine);
    }
    static fromHex(d2) {
      const v = h3.fromAffine(i3(et("pointHex", d2)));
      return v.assertValidity(), v;
    }
    static fromPrivateKey(d2) {
      return h3.BASE.multiply(a(d2));
    }
    static msm(d2, v) {
      return hc(h3, r2, d2, v);
    }
    _setWindowSize(d2) {
    ...
    double() {
      ...
      return _ = n2.add(_, _), T = n2.mul(O2, $), T = n2.add(T, T), B3 = n2.mul(d2, T), A2 = n2.mul(m2, U4), A2 = n2.add(B3, A2), B3 = n2.sub(L, A2), A2 = n2.add(L, A2), A2 = n2.mul(B3, A2), B3 = n2.mul(_, B3), T = n2.mul(m2, T), U4 = n2.mul(d2, U4), _ = n2.sub(S2, U4), _ = n2.mul(d2, _), _ = n2.add(_, T), T = n2.add(S2, S2), S2 = n2.add(T, S2), S2 = n2.add(S2, U4), S2 = n2.mul(S2, _), A2 = n2.add(A2, S2), U4 = n2.mul(N, $), U4 = n2.add(U4, U4), S2 = n2.mul(U4, _), B3 = n2.sub(B3, S2), T = n2.mul(U4, L), T = n2.add(T, T), T = n2.add(T, T), new h3(B3, A2, T);
    }
    add(d2) {
      u2(d2);
      ...
      let I2 = n2.add(N, B3);
      return b = n2.mul(b, I2), I2 = n2.add(_, g), b = n2.sub(b, I2), I2 = n2.add(m2, O2), A2 = n2.add($, B3), I2 = n2.mul(I2, A2), A2 = n2.add(j, g), I2 = n2.sub(I2, A2), S2 = n2.mul(L, b), A2 = n2.mul(U4, g), S2 = n2.add(A2, S2), A2 = n2.sub(j, S2), S2 = n2.add(j, S2), T = n2.mul(A2, S2), j = n2.add(_, _), j = n2.add(j, _), g = n2.mul(L, g), b = n2.mul(U4, b), j = n2.add(j, g), g = n2.sub(_, g), g = n2.mul(L, g), b = n2.add(b, g), _ = n2.mul(j, b), T = n2.add(T, _), _ = n2.mul(I2, b), A2 = n2.mul(w, A2), A2 = n2.sub(A2, _), _ = n2.mul(w, j), S2 = n2.mul(I2, S2), S2 = n2.add(S2, _), new h3(A2, T, S2);
    }
    subtract(d2) {
    ...
    wNAF(d2) {
      return E2.wNAFCached(this, d2, h3.normalizeZ);
    }
    multiplyUnsafe(d2) {
      const { endo: v, n: m2 } = e;
      ft("scalar", d2, dt, m2);
      ...
      if (!v || E2.hasPrecomputes(this)) return E2.wNAFCachedUnsafe(this, d2, h3.normalizeZ);
      ...
      return N && (T = T.negate()), B3 && (S2 = S2.negate()), S2 = new h3(n2.mul(S2.px, v.beta), S2.py, S2.pz), T.add(S2);
    }
    multiply(d2) {
      const { endo: v, n: m2 } = e;
      ft("scalar", d2, K, m2);
      ...
      if (v) {
        ...
        S2 = E2.constTimeNegate($, S2), U4 = E2.constTimeNegate(A2, U4), U4 = new h3(n2.mul(U4.px, v.beta), U4.py, U4.pz), O2 = S2.add(U4), N = L.add(_);
      } else {
        const { p: $, f: B3 } = this.wNAF(d2);
        O2 = $, N = B3;
      }
      return h3.normalizeZ([O2, N])[0];
    }
    multiplyAndAddUnsafe(d2, v, m2) {
      const O2 = h3.BASE, N = (B3, A2) => A2 === dt || A2 === K || !B3.equals(O2) ? B3.multiplyUnsafe(A2) : B3.multiply(A2), $ = N(this, v).add(N(d2, m2));
      return $.is0() ? void 0 : $;
    }
    toAffine(d2) {
      return l2(this, d2);
    ...
    isTorsionFree() {
      ...
      if (d2 === K) return true;
      if (v) return v(h3, this);
      throw new Error("isTorsionFree() has not been declared for the elliptic curve");
    }
    clearCofactor() {
      const { h: d2, clearCofactor: v } = e;
      return d2 === K ? this : v ? v(h3, this) : this.multiplyUnsafe(e.h);
    }
    toRawBytes(d2 = true) {
      return Ct("isCompressed", d2), this.assertValidity(), o2(h3, this, d2);
    }
    toHex(d2 = true) {
  ...
  return { CURVE: e, ProjectivePoint: h3, normPrivateKeyToScalar: a, weierstrassEquation: s, isWithinCurveOrder: c };
}
function Bc(t) {
  const e = Wr(t);
...
function Ic(t) {
  ...
  const { ProjectivePoint: a, normPrivateKeyToScalar: u2, weierstrassEquation: l2, isWithinCurveOrder: f6 } = Ac({ ...e, toBytes(g, w, b) {
  ...
  class d2 {
    ...
    recoverPublicKey(w) {
      ...
      const P4 = (R3 & 1) === 0 ? "02" : "03", k2 = a.fromHex(P4 + h3(C4)), M3 = c(C4), D = s(-x * M3), z = s(I2 * M3), Z2 = a.BASE.multiplyAndAddUnsafe(k2, D, z);
  ...
  function S2(g, w, b = L) {
    ...
    function st2(W) {
      const J2 = $(W);
      if (!f6(J2)) return;
      const Be3 = c(J2), zt = a.BASE.multiply(J2).toAffine(), vt = s(zt.x);
      if (vt === dt) return;
      const Zt = s(Be3 * s(Z2 + vt * M3));
      if (Zt === dt) return;
      let Ut = (zt.x === vt ? 0 : 2) | Number(zt.y & K), vn2 = Zt;
      return x && y3(Zt) && (vn2 = E2(Zt), Ut ^= 1), new d2(vt, vn2, Ut);
    }
  ...
  function j(g, w, b, I2 = U4) {
    ...
    C4 && (w = e.hash(w));
    const { r: Z2, s: st2 } = D, W = B3(w), J2 = c(st2), Be3 = s(W * J2), zt = s(Z2 * J2), vt = a.BASE.multiplyAndAddUnsafe(z, Be3, zt)?.toAffine();
    return vt ? s(vt.x) === Z2 : false;
  }
...
function rr2(r2, e) {
  ...
  function d2(u2) {
    ...
    for (var j = (D - I2) * l2 + 1 >>> 0, T = new Uint8Array(j); I2 !== D; ) {
    ...
    for (var me2 = c.repeat(b); H2 < j; ++H2) me2 += r2.charAt(T[H2]);
    return me2;
  }
  function g(u2) {
    ...
    var b = 0;
    if (u2[b] !== " ") {
      for (var x = 0, I2 = 0; u2[b] === c; ) x++, b++;
      for (var D = (u2.length - b) * h3 + 1 >>> 0, j = new Uint8Array(D); u2[b]; ) {
        var T = t[u2.charCodeAt(b)];
        if (T === 255) return;
...
var dr = class {
  constructor(e, t, i3, s) {
    this.name = e, this.prefix = t, this.baseEncode = i3, this.baseDecode = s, this.encoder = new hr(e, t, i3), this.decoder = new lr(e, t, s);
  }
  encode(e) {
...
var Ee2 = ({ name: r2, prefix: e, encode: t, decode: i3 }) => new dr(r2, e, t, i3);
var de = ({ prefix: r2, name: e, alphabet: t }) => {
...
var gr = (r2, e, t, i3) => {
  ...
  for (let l2 = 0; l2 < n2; ++l2) {
    ...
    c = c << t | d2, a += t, a >= 8 && (a -= 8, o2[h3++] = 255 & c >> a);
  }
...
var pr = (r2, e, t) => {
  ...
  if (o2 && (n2 += e[s & a << t - o2]), i3) for (; n2.length * t & 7; ) n2 += "=";
  return n2;
};
var P3 = ({ name: r2, prefix: e, bitsPerChar: t, alphabet: i3 }) => Ee2({ prefix: e, name: r2, encode(s) {
  return pr(s, i3, t);
}, decode(s) {
  return gr(s, i3, t, r2);
} });
...
function ai(r2, e, t) {
  e = e || [], t = t || 0;
  for (var i3 = t; r2 >= sn3; ) e[t++] = r2 & 255 | oi, r2 /= 128;
  for (; r2 & tn2; ) e[t++] = r2 & 255 | oi, r2 >>>= 7;
...
var Ke = (r2, e) => {
  ...
  return li2(r2, n2, 0), li2(t, n2, i3), n2.set(e, s), new mn(r2, t, e, n2);
};
var mn = class {
  constructor(e, t, i3, s) {
...
var fn2 = class {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array ? Ke(this.code, t) : t.then((i3) => Ke(this.code, i3));
...
//# sourceMappingURL=chunk-H35BMSY5.js.map
